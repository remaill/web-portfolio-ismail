...
const Footer = () => {
  return (
    <div className="bg-slate-900" id="contact">
      <div className="max-w-2xl mx-auto text-white py-10">
        <div className="text-center">
          ...
          <div className='flex justify-center items-center gap-2'>
             {/* Github */}
          <a href="https://github.com/remaill" target="_blank" rel="noopener noreferrer">
            <button
              type="button"
          ...
          {/* Instagram */}
          <a href="https://www.instagram.com/re_maill/" target="_blank" rel="noopener noreferrer">
            <button
              type="button"
              className="mb-2 inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
      ...
      {/* Youtube */}
      <a href="https://www.youtube.com/@Kita_dimana" target="_blank" rel="noopener noreferrer">
        <button
          type="button"
          data-te-ripple-init
          data-te-ripple-color="light"
      ...
      <div className="mt-20 flex flex-col md:flex-row md:justify-between items-center text-sm text-gray-400">
                    <p className="order-2 md:order-1">Email : ismail.est2002@gmail.com </p>
                    <p className="order-1 md:order-2">Phone : +62 858 1971 7587</p>
                </div>
                <p className='items-center text-sm text-gray-400 mt-7'> &copy; Made by Muhamad Ismail, built with Next.js, 2024. </p>
        </div>
      </div>
    </div>
  )
